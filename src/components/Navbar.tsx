    ...
    <>
      <nav
        className={`fixed top-0 z-50 w-full transition-all duration-300 ease-in-out ${
          scrolled ? 'bg-[#0A0A0A]/80 backdrop-blur-md shadow-lg border-b border-[#ffffff1a]' : 'bg-[#0A0A0A]'
        }`}
      >
        <div className={`max-w-8xl mx-auto px-6 ${scrolled ? 'py-6' : 'py-8'} flex justify-between items-center`}>
          <div className="flex items-center gap-2">
            <span className="text-xl font-semibold text-white">Jogja Comtek</span>
          </div>
      ...
      {isDrawerVisible && (
        ...
        >
          ...
          <ul className="flex flex-col gap-6 text-sm font-medium">
            ...
            <li><Link href="#" onClick={closeDrawer}>PAGES</Link></li>
            <li><Link href="#" onClick={closeDrawer}>SERVICES</Link></li>
            <li><Link href="#" onClick={closeDrawer}>EVENT</Link></li>
            <li><Link href="#" onClick={closeDrawer}>BLOG</Link></li>
            <li><Link href="#" onClick={closeDrawer}>CONTACT</Link></li>
            <li>
